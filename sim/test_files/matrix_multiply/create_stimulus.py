...
if __name__ == "__main__":
    ...
    input_vec = "/home/advent2/Simple_NoC/sim/test_files/matrix_multiply/input_vec.in"
    rf_weights = "/home/advent2/Simple_NoC/sim/test_files/matrix_multiply/rf_weights.in"

    # Example usage
    file_specs = [
        {'num_columns': 128, 'num_rows': 1, 'output_file': input_vec},
        {'num_columns': 128, 'num_rows': 128, 'output_file': rf_weights}
    ]
    main(file_specs)
